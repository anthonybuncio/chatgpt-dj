...
export default function Generator() {
  ...
  const handleSubmit = async (event) => {
    ...
    const input = `I want you to act as a song recommender. I will provide you with a list of up to 5 songs and you will create a playlist of 10 songs that are similar to the given songs. And you will provide a playlist name and description for the playlist. Do not choose songs that are same name or artist. Do not write any explanations or other words, just reply with the playlist name, description and the songs. The songs are: 1. Drake - Fire & Desire 2. Lil Uzi Vert - I just wanna rock 3. Future - Wait for you`;
