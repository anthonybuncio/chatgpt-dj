...
const SpotifyArtists = () => {
  const { data: artists } = useSWR("/api/stats/top-artists", fetcher);

  console.log("front end data", artists);
  let defaultTransform = 0;
  function goNext() {
    defaultTransform = defaultTransform - 398;
    var slider = document.getElementById("artist-slider");
